...
nova.widgets.Carousel = function (wrapper) {
    nova.Widget.call(this, wrapper);
    this.vertical = false;
    this.horizontal = true;
    this.looping = true;
};
nova.widgets.Carousel.prototype = new nova.Widget();
nova.widgets.Carousel.constructor = nova.widgets.Carousel;

nova.widgets.Carousel.prototype.init = function () {
    var obj = this;
    var $carousel = $(this.wrapper);
...
nova.widgets.Carousel.prototype.goto = function (indexOrSelector) {

};

nova.widgets.Carousel.prototype.onViewChanged = function (handler) {
