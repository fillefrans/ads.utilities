...
<head>
  ...
  <!-- Stuff needed for the Google Map -->
  <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
  <script type="text/javascript" src="modules/map/gmaps.js"></script>
...
-->
  <div id="mainpage" data-role="page">
  	...
  	<div class="header">
  		<div class="inner">
  			<header>
  				...
  				<img class="secondlogo left" src="img/gfx/logo-premiumreseller.png" alt="Humac is a official premium Apple reseller" />
  			</header>
  		</div>
  	</div>
    ...
    <div class="maincontent">
      <div class="inner">
        ...
        <article data-role="content" class="content">
          <h1>Bes&oslash;ke  v&aring;r nye butikk!</h1>
    ...
    <div class="links">
    	<div class="inner">
            <nav>
              <a href="https://maps.google.no/maps?q=Humac+Oslo+City&hl=nl&ll=59.912579,10.752997&spn=0.008638,0.013883&cid=16672965058922032176&gl=NO&t=m&z=16&iwloc=A" data-role="button" class="left" data-theme="a" rel="external">Plan rute</a>
              <a href="http://www.humac.no" data-role="button" class="left" data-theme="a" data-transition="slide" rel="external">Visit Humac.no</a>     
            </nav>
        </div>
    </div>
